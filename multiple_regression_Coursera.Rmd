...
summary(evals$score)
p <- ggplot(data = evals, aes(x = score)) + geom_histogram(binwidth = 0.05, color = "darkblue", fill = "lightblue")
...
# Interesting... a clear (if dispersed) association. So...
...
# Also interesting, in that it appears to have very little impact.
