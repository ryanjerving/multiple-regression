...
NOTE: Observational: using already generated data.
...
NOTE: Because this is an observational study, we can talk about correlation but not causation. The question should be rephrased as: "Is there an association between beauty and course evaluations" to reflect this.
...
# This shows that the median is at 4.3, with the third quartile ceilings at 4.6 (i.e., 25% of students gave their professors a score of over 4.6) -- students at UT Austin like their professors!

# The following histogram will also show that 11 students gave a professor a score below 3 (just eyeball counting). That leaves as the false answer that the "left skewness" (true) suggests students are "less likely" (false -- more likely) to rate their professors highly.
...
# How does ethicity of professor impact average rating of the beauty?
...
# A residuals plot can show whether scatter around the line of zero divergence from the predicted value is more or less random:
